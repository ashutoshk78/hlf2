...
```bash
kubectl delete fabricorderernodes.hlf.pkuidlabs.com --all-namespaces --all
kubectl delete fabricpeers.hlf.pkuidlabs.com --all-namespaces --all
kubectl delete fabriccas.hlf.pkuidlabs.com --all-namespaces --all
kubectl delete fabricchaincode.hlf.pkuidlabs.com --all-namespaces --all
```
