...
import (
	...
	"encoding/base64"
	"fmt"
	"github.com/kfsoftware/hlf-operator/api/hlf.pkuidlabs.com/v1alpha1"
...
func (c *updateExternalChaincodeCmd) run() error {
	...
	if c.force {
		...
		fabricChaincode.Annotations["hlf.pkuidlabs.com/updatedtime"] = time.Now().UTC().Format(time.RFC3339)
	}
