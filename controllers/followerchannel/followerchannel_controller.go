...
const mainChannelFinalizer = "finalizer.mainChannel.hlf.pkuidlabs.com"
...
// +kubebuilder:rbac:groups=hlf.pkuidlabs.com,resources=fabricfollowerchannels,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=hlf.pkuidlabs.com,resources=fabricfollowerchannels/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=hlf.pkuidlabs.com,resources=fabricfollowerchannels/finalizers,verbs=get;update;patch
