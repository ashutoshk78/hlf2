...
const identityFinalizer = "finalizer.identity.hlf.pkuidlabs.com"
...
// +kubebuilder:rbac:groups=hlf.pkuidlabs.com,resources=fabricidentities,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=hlf.pkuidlabs.com,resources=fabricidentities/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=hlf.pkuidlabs.com,resources=fabricidentities/finalizers,verbs=get;update;patch
