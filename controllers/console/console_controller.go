...
import (
	...
	hlfv1alpha1 "github.com/kfsoftware/hlf-operator/api/hlf.pkuidlabs.com/v1alpha1"
...
const consoleFinalizer = "finalizer.console.hlf.pkuidlabs.com"

// +kubebuilder:rbac:groups=hlf.pkuidlabs.com,resources=fabricpeers,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=hlf.pkuidlabs.com,resources=fabricpeers/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=hlf.pkuidlabs.com,resources=fabricpeers/finalizers,verbs=get;update;patch

// +kubebuilder:rbac:groups=hlf.pkuidlabs.com,resources=console,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=hlf.pkuidlabs.com,resources=console/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=hlf.pkuidlabs.com,resources=console/finalizers,verbs=get;update;patch

// +kubebuilder:rbac:groups=hlf.pkuidlabs.com,resources=fabricorderernodes,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=hlf.pkuidlabs.com,resources=fabricorderernodes/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=hlf.pkuidlabs.com,resources=fabricorderernodes/finalizers,verbs=get;update;patch

// +kubebuilder:rbac:groups=hlf.pkuidlabs.com,resources=fabricorderingservices,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=hlf.pkuidlabs.com,resources=fabricorderingservices/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=hlf.pkuidlabs.com,resources=fabricorderingservices/finalizers,verbs=get;update;patch

// +kubebuilder:rbac:groups=hlf.pkuidlabs.com,resources=fabriccas,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=hlf.pkuidlabs.com,resources=fabriccas/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=hlf.pkuidlabs.com,resources=fabriccas/finalizers,verbs=get;update;patch
