...
const chaincodeFinalizer = "finalizer.chaincode.hlf.pkuidlabs.com"
...
// +kubebuilder:rbac:groups=hlf.pkuidlabs.com,resources=fabricchaincodes,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=hlf.pkuidlabs.com,resources=fabricchaincodes/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=hlf.pkuidlabs.com,resources=fabricchaincodes/finalizers,verbs=get;update;patch
func (r *FabricChaincodeReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err != nil {
		...
		if cryptoData.Updated {
			...
			deployment.Spec.Template.ObjectMeta.Annotations["hlf.pkuidlabs.com/updatedsecrettime"] = time.Now().UTC().Format(time.RFC3339)
		}
