...
const networkConfigFinalizer = "finalizer.networkConfig.hlf.pkuidlabs.com"
...
// +kubebuilder:rbac:groups=hlf.pkuidlabs.com,resources=fabricnetworkconfigs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=hlf.pkuidlabs.com,resources=fabricnetworkconfigs/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=hlf.pkuidlabs.com,resources=fabricnetworkconfigs/finalizers,verbs=get;update;patch
